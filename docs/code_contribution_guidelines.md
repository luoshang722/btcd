...
reason, the qtumd suite has a formalized and rigorous development process which
...
- [Effective Go](http://golang.org/doc/effective_go.html) - The entire qtumd
...
One of the major design goals of all core qtumd packages is to aim for complete
...
commits](https://github.com/luoshang722/qtumd/commits/master) for examples of
commit messages.
...
contributions.  This is how to get your changes into qtumd.
...
Rejoice as you will now be listed as a [contributor](https://github.com/luoshang722/qtumd/graphs/contributors)!
...
[ISC license](https://github.com/luoshang722/qtumd/blob/master/LICENSE).  This is
the same license as all of the code in the qtumd suite.
