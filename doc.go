...
/*
qtumd is a full-node bitcoin implementation written in Go.

The default options are sane for most users.  This means qtumd will work 'out of
...
parsed when qtumd starts up.  By default, the configuration file is located at
~/.qtumd/qtumd.conf on POSIX-style operating systems and %LOCALAPPDATA%\qtumd\qtumd.conf
